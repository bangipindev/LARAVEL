	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			<div class="x_panel">
				<div class="row">
					<div class="x_content">
						<form action="{{ url('appmaster/categories/create') }}" id="formkategori" class="form-horizontal form-bordered form-row-stripped" method="POST">
							@csrf
							...
							<div class="item form-group">
								<div class="col-md-4 col-md-offset-8">
									<a href=" {{ url('appmaster/categories') }}" class="btn btn-primary" name="back"><i class="fa fa-angle-left"></i> Back</a>
